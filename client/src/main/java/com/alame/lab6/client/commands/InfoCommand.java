...
import com.alame.lab6.common.request.GetInfoRequest;
...
public class InfoCommand implements Command {
    ...
    public InfoCommand(Printer printer, RequestSender requestSender){
    ...
    public boolean execute() {
        try{
            Response<String> response = requestSender.sendThenReceive(new GetInfoRequest());
    ...
    public Command newInstance() {
        return new InfoCommand(printer, requestSender);
    }
}
